...
def print_summary(artifacts: list[Artifact]) -> None:
    ...
    for artifact_type in sorted(counts):
        print(f"{artifact_type:15} {counts[artifact_type]:3}")
...
def main():
    ...
    print("ATON Docusaurus Renderer")
    print("========================")

    print()
    print("Scanning Foundation...")
